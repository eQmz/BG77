\doxysection{Ejemplo\+\_\+\+Libreria}
\hypertarget{_ejemplo__libreria-example}{}\label{_ejemplo__libreria-example}El codigo de ejemplo a continuacion, muestra como utilizar la libreria. De manera general, se necesita\+:
\begin{DoxyEnumerate}
...
\item Recepcion y transmision de mensajes. 10.\+1 Dependiendo del modo de acceso usar la funcion de transmision adecuada. 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{_b_g77_8c_a4324d29bee02aaf36d6d7dc3d54fa1b7}{bg\_transmit\_buffAMode}}(uint8\_t\ connectID,\ uint8\_t\ *data,\ uint16\_t\ len)}
\DoxyCodeLine{\mbox{\hyperlink{_b_g77_8c_a2eb4e7ff0044a4ccb914381d9ae25265}{bg\_transmit\_TM}}(uint8\_t\ *data,\ uint16\_t\ len)}
...
\item Usar Callbacks de notificacion de URC 11.\+1 Callback de conexion entrante. 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{_b_g77_8c_a10f9ce690b16f36b9229fecd740a6895}{bg\_incomming\_callback}}(uint8\_t\ serverID,\ uint\ *8\_t\ connectID)}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{_b_g77_8c_acefe623eef8bd29ed0f69a9d65e092a7}{bg\_callback\_TM\_Inactive}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
